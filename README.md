...
* `finding_donors.ipynb`: This is the main file where all the project work is done.
* `finding_donors.html`: Executed jupyter notebook to see the complete project without installing any dependency.
